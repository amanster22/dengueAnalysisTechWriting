...
Our LISA analysis was significant because it revealed that Dengue fever in Mérida maintained a persistent central reservoir even during the "quiet" years of 2013 and 2014 when aggregate cases plummeted. While city-wide totals suggested the outbreak was contained, the spatial analysis exposed a stable "High-High" cluster that likely acted as the stronghold from which the massive 2015 resurgence expanded. Furthermore, the analysis identified specific "safe island" neighborhoods (Low-High outliers) that remained resistant despite being surrounded by infection, pinpointing exact locations for researchers to investigate effective local protective factors.
